        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="about-left-image mb-md-30px mb-lm-30px" data-aos="fade-up">
                    <img src="{{asset("assets/images/about-image/1.jpg")}}" alt="" class="img-responsive w-100" />
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 pr-0">
                <div class="banner-product-image">
                    <a class="venobox " href="{{asset("assets/images/banner/8.jpg")}}" data-gall="myGallery">
                        <img src="{{asset("assets/images/banner/8.jpg")}}" class="img-fluid w-100" alt="Banner images">
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-md-4">
                <div class="banner-product-image mt-lm-15px">
                    <a class="venobox " href="{{asset("assets/images/banner/9.jpg")}}" data-gall="myGallery">
                        <img src="{{asset("assets/images/banner/9.jpg")}}" class="img-fluid w-100" alt="Banner images">
                    </a>
                </div>
                <div class="banner-product-image mt-3">
                    <a class="venobox " href="{{asset("assets/images/banner/10.jpg")}}" data-gall="myGallery">
                        <img src="{{asset("assets/images/banner/10.jpg")}}" class="img-fluid w-100" alt="Banner images">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-5">
                    <div class="team-single" data-aos="fade-up" data-aos-delay="0">
                        <div class="team-img">
                            <img class="img-fluid" src="{{asset("assets/images/team/leader1.png")}}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 mb-5">
                    <div class="team-single" data-aos="fade-up" data-aos-delay="200">
                        <div class="team-img">
                            <img class="img-fluid" src="{{asset("assets/images/team/leader2.png")}}" alt="">
                        </div>
                        <div class="team-content">
                ...
                <div class="col-lg-3 col-md-6 mb-5">
                    <div class="team-single" data-aos="fade-up" data-aos-delay="400">
                        <div class="team-img">
                            <img class="img-fluid" src="{{asset("assets/images/team/leader3.png")}}" alt="">
                        </div>
                        <div class="team-content">
                            <h6 class="team-name font--bold mt-5">Missa Santos</h6>
                ...
                <div class="col-lg-3 col-md-6 mb-5">
                    <div class="team-single" data-aos="fade-up" data-aos-delay="600">
                        <div class="team-img">
                            <img class="img-fluid" src="{{asset("assets/images/team/leader4.png")}}" alt="">
                        </div>
                        <div class="team-content">
                            ...
                            <div class="swiper-wrapper">
                                <div class="company-logo-single-item swiper-slide">
                                    <div class="image"><img class="img-fluid"
                                            src="{{asset("assets/images/company-logo/company-logo-1.png")}}" alt=""></div>
                                </div>
                                <div class="company-logo-single-item swiper-slide">
                                    <div class="image"><img class="img-fluid"
                                            src="{{asset("assets/images/company-logo/company-logo-2.png")}}" alt=""></div>
                                </div>
                                <div class="company-logo-single-item swiper-slide">
                                    <div class="image"><img class="img-fluid"
                                            src="{{asset("assets/images/company-logo/company-logo-3.png")}}" alt=""></div>
                                </div>
                                <div class="company-logo-single-item swiper-slide">
                                    <div class="image"><img class="img-fluid"
                                            src="{{asset("assets/images/company-logo/company-logo-4.png")}}" alt=""></div>
                                </div>
                                <div class="company-logo-single-item swiper-slide">
                                    <div class="image"><img class="img-fluid"
                                            src="{{asset("assets/images/company-logo/company-logo-5.png")}}" alt=""></div>
                                </div>
                                <div class="company-logo-single-item swiper-slide">
                                    <div class="image"><img class="img-fluid"
                                            src="{{asset("assets/images/company-logo/company-logo-6.png")}}" alt=""></div>
                                </div>
                                <div class="company-logo-single-item swiper-slide">
                                    <div class="image"><img class="img-fluid"
                                            src="{{asset("assets/images/company-logo/company-logo-7.png")}}" alt=""></div>
                                </div>
                                <div class="company-logo-single-item swiper-slide">
                                    <div class="image"><img class="img-fluid"
                                            src="{{asset("assets/images/company-logo/company-logo-8.png")}}" alt=""></div>
                                </div>
                            </div>
                        </div>
